...
class DivreWarehouseNonActiveExport implements FromCollection, WithHeadings
{
    use Exportable;
    ...
    public function collection()
    {
        ...
        $warehouseLocations = Warehouse::where('is_active', 0)
            // ->whereNull('warehouses.longitude')
        ...
        foreach($warehouseLocations as $wl){
            $export[] = [
                ...
                'region' => $wl->region,
                'name' => $wl->name,
                'is_active' => $wl->is_active ? 'Aktif' : 'Tidak Aktif'
