		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
	          	...
	          	<a href="{{url('advance_notices/inbound')}}">{{$advance_notices->where('type','inbound')->count()}}</a>
	          </span>
				</div>
				<!-- /.info-box-content -->
			</div>
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">
	          	<a href="{{url('advance_notices/outbound')}}">{{$advance_notices->where('type','outbound')->count()}}</a></span>
				</div>
				<!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number">
	          	<a href="{{url('stock_transports/inbound')}}">{{$stock_transports->where('type','inbound')->count()}}</a></span>
				</div>
				<!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
					...
					<span class="info-box-number"><a href="{{url('stock_transports/outbound')}}">{{$stock_transports->where('type','outbound')->count()}}</a></span>
				</div>
				<!-- /.info-box-content -->
			</div>
			<!-- /.info-box -->
        ...
        window.onload = function() {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                data: [{
                    ...
                    indexLabel: "{label} {y}",
                    dataPoints: {!! json_encode($comodityChart) !!}
                }]
            });
            chart.render();
            ...
            var columnChart = new CanvasJS.Chart("columnChartContainer", {
                ...
                data: [{
                    ...
                    showInLegend: true,
                    dataPoints:{!! json_encode($handlingIns) !!}
                },
                    {
                        type: "column",
                        name: "Handling Out",
                        ...
                        showInLegend: true,
                        dataPoints:{!! json_encode($handlingOuts) !!}
                    }]
            });
            columnChart.render();
            ...
            var storageChart = new CanvasJS.Chart("storageChartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: {!! json_encode($storage) !!}
                }]
            });
            storageChart.render();
