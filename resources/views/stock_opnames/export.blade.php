  ...
  <body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines">
        ...
        <tbody>
          <tr class="row0">
            <td class="column0">&nbsp;</td>
            <td class="column1"><img src="{{ public_path().'/logo.png' }}" alt="Logo BGR" width="100" height="20"></td>
            <td class="column2"></td>
            <td class="column3">&nbsp;</td>
            <td class="column4">&nbsp;</td>
            <td class="column5">&nbsp;</td>
          ...
          <tr class="row6">
            ...
            <td class="column4 style37 s">{{\Carbon\Carbon::parse($stock_opname->date)->format('D')}}</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
            <td class="column7 style32 null"></td>
            <td class="column8 style1 null"></td>
          ...
          <tr class="row7">
            ...
            <td class="column3 style33 s">:</td>
            <td class="column4 style41 s">{{\Carbon\Carbon::parse($stock_opname->date)->format('d M Y')}}</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
            <td class="column7 style32 null"></td>
            <td class="column8 style1 null"></td>
          ...
          <tr class="row8">
            ...
            <td class="column3 style33 s">:</td>
            <td class="column4 style37 s">{{ \Carbon\Carbon::parse($stock_opname->date)->format('H:m') }}</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
            <td class="column7 style32 null"></td>
            <td class="column8 style1 null"></td>
          ...
          <tr class="row9">
            ...
            <td class="column3 style33 s">:</td>
            <td class="column4 style37 s">{{ $stock_opname->warehouse->name }}</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
            <td class="column7 style32 null"></td>
            <td class="column8 style1 null"></td>
          ...
          <tr class="row10">
            ...
            <td class="column3 style33 s">:</td>
            <td class="column4 style37 s">{{ $stock_opname->warehouse->address }}</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
            <td class="column7 style32 null"></td>
            <td class="column8 style1 null"></td>
          ...
          <tr class="row11">
            ...
            <td class="column3 style33 s">:</td>
            <td class="column4 style37 s">{{ number_format($stock_opname->warehouse->length * $stock_opname->warehouse->width, 2, ',', '.') }} Ton</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
            <td class="column7 style32 null"></td>
            <td class="column8 style1 null"></td>
          ...
          <tr class="row14">
            <td class="column0">&nbsp;</td>
            <td class="column1">&nbsp;</td>
            <td class="column2 style34 n">{{ $loop->iteration }}</td>
            <td class="column3 style33 null"></td>
            <td class="column4 style37 s">{{ $value }}</td>
            <td class="column5 style32 null"></td>
            <td class="column6 style32 null"></td>
          ...
          <tr class="row18">
            ...
            <td class="column5 style84 s style86" colspan="5">Stock Awal Tanggal {{\Carbon\Carbon::parse($stock_opname->date)->format('d M Y')}}</td>
            <td class="column10 style83 s style83" colspan="5">Realisasi s/d Tanggal Pemeriksaan</td>
            <td class="column15 style83 s style83" colspan="5">Stock Adm./Phisik Setelah Rekonsiliasi Tanggal {{\Carbon\Carbon::parse($stock_opname->date)->format('d M Y')}}</td>
          ...
          <tr class="row23">
            <td class="column0">&nbsp;</td>
            <td class="column0">{{ $loop->iteration }}</td>
            <td class="column2 style67 s style68" colspan="2">{{ $stock_opname->warehouse->name }}</td>
            <td class="column4 style38 s">{{ $detail->item ?  $detail->item->name : '' }}</td>
            <td class="column4 style38 s">{{ $detail->item ?  $detail->item->name : '' }}</td>
            <td class="column5 style20 n">{{ $detail->sto_awal }}</td>
            <td class="column6 style20 n">&nbsp;&nbsp;{{ $detail->so_awal }} </td>
            <td class="column7 style62 n style63" colspan="2">&nbsp;&nbsp;{{ $detail->stock_awal_adm }} </td>
            <td class="column9 style20 f">&nbsp;&nbsp;{{ $detail->phisik_awal }} </td>
            <td class="column10 style20 n">{{ $detail->realisasi_adm_penerimaan }}</td>
            <td class="column11 style20 n">{{ $detail->realisasi_phisik_penerimaan }}</td>
            <td class="column12 style20 n">{{ $detail->susut_bar }}</td>
            <td class="column13 style20 n">{{ $detail->realisasi_adm_pengeluaran }}</td>
            <td class="column14 style20 n">{{ $detail->realisasi_phisik_pengeluaran }}</td>
            <td class="column15 style20 f">&nbsp;&nbsp;{{$detail->stock_akhir_adm }}</td>
            <td class="column16 style20 f">{{ $detail->po_sto_akhir }}</td>
            <td class="column17 style20 f">&nbsp;&nbsp;{{ $detail->so_akhir }} </td>
            <td class="column18 style20 f">&nbsp;&nbsp;{{$detail->stock_phisik_akhir}} </td>
            <td class="column19 style20 n">&nbsp;&nbsp;{{$detail->stock_taking_akhir}} </td>
            <td class="column20 style29 f">{{$detail->selisih}}</td>
          ...
          <tr class="row28">
            ...
            <td class="column5 style25 f">{{ $total_sto_awal }}</td>
            <td class="column6 style25 f">&nbsp;&nbsp;{{ $total_so_awal }} </td>
            <td class="column7 style47 f style48" colspan="2">&nbsp;&nbsp;{{ $total_stock_awal_adm }} </td>
            <td class="column9 style25 f">&nbsp;&nbsp;{{ $total_phisik_awal }} </td>
            <td class="column10 style25 f">{{ $total_realisasi_adm_penerimaan }}</td>
            <td class="column11 style25 f">{{ $total_realisasi_phisik_penerimaan }}</td>
            <td class="column12 style25 f">{{ $total_susut_bar }}</td>
            <td class="column13 style25 f">{{ $total_realisasi_adm_pengeluaran }}</td>
            <td class="column14 style25 f">{{ $total_realisasi_phisik_pengeluaran }}</td>
            <td class="column15 style27 f">&nbsp;&nbsp;{{ $total_stock_akhir_adm }} </td>
            <td class="column16 style27 f">{{ $total_po_sto_akhir }}</td>
            <td class="column17 style25 f">&nbsp;&nbsp;{{ $total_so_akhir }}</td>
            <td class="column18 style27 f">&nbsp;&nbsp;{{ $total_stock_phisik_akhir }} </td>
            <td class="column19 style25 f">&nbsp;&nbsp;{{ $total_stock_taking_akhir }} </td>
            <td class="column20 style31 f">{{ $total_selisih }}</td>
            <td class="column21 style26 null"></td>
          </tr>
          <tr class="row29">
            <td class="column0">&nbsp;</td>
