		...
		<div class="row">
			<div class="col-sm-6">
				...
				<!-- <div class="form-group required">
					...
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'readonly' }} type="text" name="sptb_num" class="form-control" placeholder="SPTB" value="{{old('sptb_num', $advanceNotice->sptb_num)}}" required="required">
					</div>
				</div> -->
				<div class="form-group required">
					<label for="sptb_num" class="col-sm-3 control-label">Customer Reference</label>
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'readonly' }} type="text" name="ref_code" class="form-control" placeholder="Customer Reference" value="{{old('ref_code', $advanceNotice->ref_code)}}" required="required">
					</div>
				</div>
				<div class="form-group required">
					<label for="sppk_num" class="col-sm-3 control-label">SPPK</label>
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'readonly' }} type="text" name="sppk_num" class="form-control" placeholder="SPPK" value="{{old('sppk_num', $advanceNotice->sppk_num)}}" required="required">
					</div>
				</div>
				<div class="form-group required">
					...
					<div class="col-sm-9">
						@if($method != 'PUT')
						<input type="file" name="sppk_doc" class="form-control" placeholder="SPTB" value="{{old('sppk_doc', $advanceNotice->sppk_doc)}}" required="required">
						@else
						<a href="{{ \Storage::disk('public')->url($advanceNotice->sppk_doc) }}" target="_blank">Lihat Dokumen</a>
						@endif
					</div>
				</div>
				@if(!Auth::user()->hasRole('CargoOwner'))
					<div class="form-group required">
						...
						<div class="col-sm-9">
							@if($method == 'PUT')
							<input type="text" id="employee_name" name="employee_name" readonly class="form-control" placeholder="Warehouse Supervisor" value="{{old('employee_name', $advanceNotice->employee_name )}}" required="required">
							@else
							<select class="form-control" name="employee_name" id="employee_name" required required="required">
								...
								<option value="{{$warehouseOfficer->first_name}}" @if(old('employee_name', $advanceNotice->employee_name) == $advanceNotice->employee_name)){{'selected'}}@endif>{{$warehouseOfficer->first_name}}</option>
								@endforeach
								@endif
							</select>
						</div>
			...
			<div class="col-sm-6">
				...
				<div class="form-group required">
					...
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'disabled' }} type="text" name="etd" class="datepicker form-control" placeholder="Est. Time Delivery" value="{{old('etd', $advanceNotice->etd)}}" required="required">
					</div>
				</div>
				<div class="form-group required">
				...
				<div class="form-group required">
					...
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'readonly' }} type="text" id="shipper_address" name="shipper_address" class="form-control" placeholder="Address" value="{{old('shipper_address', $advanceNotice->shipper_address)}}" required="required">
					</div>
				</div>
				<div class="form-group required">
				...
				<div class="form-group required">
					<label for="consignee_id" class="col-sm-3 control-label">
						@if($type == 'inbound') Cabang/Subcabang @else Consignee @endif
					</label>
					<div class="col-sm-9">
				...
				<div class="form-group required">
					<label for="consignee_address" class="col-sm-3 control-label">
						@if($type == 'inbound') Cabang/Subcabang @else Consignee @endif Address
					</label>
					<div class="col-sm-9">
				...
				<!-- <div class="form-group required">
					...
					<div class="col-sm-9">
						<textarea {{ $method != 'PUT' ?'': 'readonly' }} type="text" id="annotation" name="annotation" class="form-control" placeholder="Annotation" required="required">{{old('annotation', $advanceNotice->annotation)}}</textarea>
					</div>
				</div>
				...
				<div class="form-group required">
					...
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'readonly' }} type="text" id="contractor" name="contractor" class="form-control" placeholder="Contractor" value="{{old('contractor', $advanceNotice->contractor)}}" required="required">
					</div>
				</div> -->
				...
				<!-- <div class="form-group required">
					...
					<div class="col-sm-9">
						<input {{ $method != 'PUT' ?'': 'readonly' }} type="text" id="head_ds" name="head_ds" class="form-control" placeholder="Head Cabang/Subcabang" value="{{old('head_ds', $advanceNotice->head_ds)}}" required="required">
					</div>
				</div>				 -->
			</div>
		</div>
