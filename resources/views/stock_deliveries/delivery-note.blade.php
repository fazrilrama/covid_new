...
<div class="print">
        ...
        <div class="col-12">
            <div class="amazonLink">
                ...
                <div class="amazonLink__image" >
                    <img src="{{\Storage::disk('public')->url($stockDelivery->qr_code)}}" alt="" srcset="">
                </div> 
            </div>
    ...
    <div class="wrapper">
        <div class="col-6">
            ...
            <div class="wrapper">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->project->company->name}}</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
            ...
            <div class="wrapper">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->shipper->name}}</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->shipper_address}}</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->shipper->postal_code}}</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->total_collie}} Box</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->total_weight}} Kg</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->total_volume}} m<sup>3</sup></p>
                </div>
            </div>
        </div>
        <div class="col-6">
            ...
            <div class="wrapper">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->consignee->phone_number}}</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
            ...
            <div class="wrapper">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->consignee->postal_code}}</p>
                </div>
            </div>
            <div class="wrapper">
                <div class="col-4">
                ...
                <div class="col-8">
                    <p>: {{$stockDelivery->transport_type->name}}</p>
                </div>
            </div>
            @if($stockDelivery->project_id != 333)
            <div class="wrapper">
                <div class="col-4">
    ...
    <br>
    @if($stockDelivery->type_payment != null)
        <table>
            <tr>
                <td colspan="4"><b>{{ strtoupper($stockDelivery->type_payment) }}</b></td>
                @if($stockDelivery->type_payment == 'cod')
                <td >Rp. {{ number_format($stockDelivery->remaining_total,2,',','.') }}</td>
                @endif
            </tr>
        </table>
        @endif
...
<table class="tg" id="delivery-note">
    ...
    <tr>
        ...
        <td class="tg-s268" style="border-top-width:0px;text-align: center">      
            @if($stockDelivery->employee_name)
                ({{ $stockDelivery->employee_name }})
            @else
                (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)
            @endif
        </td>
        <td class="tg-s268" style="border-top-width:0px;text-align: center">
            @if($stockDelivery->driver_name)
                ({{ $stockDelivery->driver_name }})
            @else
                (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;)
            @endif
        </td>
