...
<?php $__env->startSection('content_header'); ?>
    <div class="container">
        <ul class="progressbar">
            <li class="active">Buat <?php if($type=='inbound'): ?> STOI <?php else: ?> STOO <?php endif; ?></li>
            <li>Tambah Item</li>
            <li>Complete</li>
        </ul>
    </div>
    <h1 style="float:left">Create <?php if($type=='inbound'): ?> STOI <?php else: ?> STOO <?php endif; ?></h1>
