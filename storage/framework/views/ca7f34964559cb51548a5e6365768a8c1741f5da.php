...
<div class="container">
    <ul class="progressbar">
        <li>Buat <?php if($type=='inbound'): ?> AIN <?php else: ?> AON <?php endif; ?></li>
...
<h1>Edit <?php if($type=='inbound'): ?> AIN <?php else: ?> AON <?php endif; ?> #<?php echo e($advanceNotice->code); ?>
      ...
      <div class="box-header with-border">
        ...
        <?php if($advanceNotice->status == 'Processed' && $advanceNotice->accepted_note != null && $advanceNotice->is_accepted == 2): ?>
			<div class="alert alert-danger">
					Ditolak dengan catatan:  <?php echo e($advanceNotice->accepted_note); ?>
          ...
          <div class="btn-toolbar">
            <?php if($advanceNotice->status != 'Completed'): ?>
              <div class="btn-group" role="group">
                <a href="<?php echo e(url('advance_notice_details/create/'.$advanceNotice->id)); ?>" type="button" class="btn btn-success" title="Create">
...
<?php echo $__env->make('otp', ['url' => route('advance_notices.completed', ['advance_notice' => $advanceNotice->id])], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
