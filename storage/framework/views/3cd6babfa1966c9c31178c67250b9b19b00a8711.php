...
<h1><?php echo e(__('lang.edit')); ?> <?php if($type=='inbound'): ?> Goods Receiving <?php else: ?> Delivery Plan <?php endif; ?> #<?php echo e($stockTransport->code); ?>
  ...
  <?php endif; ?>
  <?php if($stockTransport->status == 'Processed' && $stockTransport->type == 'inbound' && $jumlah_item_transport_no_actual == 0): ?>
