...
<body>
    <table width="100%">
        ...
        <tr>
            <td>Quantity</td>
            <td>: <?php echo e(number_format($advanceNotice->details->sum('weight'))); ?> Kg</td>
            <td></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
    ...
    <table align="right">
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td align="right" style="vertical-align: top;">Cabang/Subcabang</td>
