...
<form id="changeStock" action="<?php echo e($action); ?>" method="POST" class="form-horizontal">
	...
	<div class="box-body">
			...
			<div class="col-sm-9">
				<select class="form-control" name="item_and" id="item_and" required>
					...
					<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($itemValue->id.','.$advanceNoticeDetail->stock_advance_notice_id); ?>" <?php if(old('item_id', $advanceNoticeDetail->item_id) == $itemValue->id): ?><?php echo e('selected'); ?><?php endif; ?>>
                            <?php echo e($itemValue->sku); ?> - <?php echo e($itemValue->name); ?> 
                            <?php if($advanceNoticeDetail->header->type == 'outbound'): ?> 
                                (Outstanding dari Stock Allocation:<?php echo e($itemValue->stock); ?>) 
                            <?php endif; ?>
                        </option>
		...
		<div class="form-group required">
			...
			<div class="col-sm-9">
                ...
                <select name="group_references" id="input" class="form-control" required="">
                    ...
                    <!-- <?php if(!empty($groupReferences)): ?>
                        <?php $__currentLoopData = $groupReferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupReference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($groupReference->ref_code); ?>" <?php echo e(old('group_reference', $advanceNoticeDetail->ref_code) == $groupReference->ref_code ? 'selected' : ''); ?> ><?php echo e($groupReference->ref_code); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php elseif(session('groupReferences')): ?>
                        <?php $__currentLoopData = session('groupReferences'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupReference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($groupReference->ref_code); ?>" <?php echo e(old('group_reference', $advanceNoticeDetail->ref_code) == $groupReference->ref_code ? 'selected' : ''); ?> ><?php echo e($groupReference->ref_code); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?> -->
                </select>
                <?php else: ?>
                	<input type="text" name="group_references" class="form-control" placeholder="Group Reference" value="<?php echo e(old('group_reference', $advanceNoticeDetail->ref_code)); ?>" required>
                <?php endif; ?>
                <?php if($advanceNoticeDetail->header->type == 'outbound'): ?>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<p class="form-control-static" id="default_uom_name">
					<?php if(session('uom_name')): ?>
						<?php echo e(session('uom_name')); ?>

					<?php else: ?>
						<?php echo e(@$advanceNoticeDetail->uom->name); ?>
		...
		<div class="form-group required">
			...
			<div class="col-sm-9">
				<input type="text" id="qty_change_and" name="qty_change_and" class="form-control" placeholder="qty"  value="<?php echo e(old('qty', $advanceNoticeDetail->qty)); ?>" required>
			</div>
		</div>
		<div class="form-group required">
			<label for="weight" class="col-sm-3 control-label">Weight</label>
			<div class="col-sm-9">
				<input type="text" name="weight" class="form-control" placeholder="Weight" value="<?php echo e(old('weight', $advanceNoticeDetail->weight)); ?>" required>
			</div>
		</div>
		<div class="form-group required">
			<label for="volume" class="col-sm-3 control-label">Volume</label>
			<div class="col-sm-9">
				<input type="text" name="volume" class="form-control" placeholder="Volume" value="<?php echo e(old('volume', $advanceNoticeDetail->volume)); ?>" required>
			</div>
		</div>
