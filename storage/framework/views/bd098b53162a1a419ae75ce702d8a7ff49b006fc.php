<div class="box-body">
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-sm-9">
				<?php if($user->user_id): ?>
				<p class="form-control-static"><?php echo e($user->user_id); ?></p>
				<input type="hidden" id="user_id_edit" name="user_id_edit" value="<?php echo e($user->id); ?>">
				<?php else: ?>
				<input type="text" name="user_id" class="form-control" placeholder="User ID" value="<?php echo e(old('user_id', $user->user_id)); ?>">
				<?php endif; ?>
		...
		<div class="form-group required">
			...
			<div class="col-sm-9">
				<input type="text" name="first_name" class="form-control" placeholder="Nama Depan" value="<?php echo e(old('first_name', $user->first_name)); ?>">
			</div>
		</div>
		<div class="form-group">
			<label for="last_name" class="col-sm-3 control-label">Nama Belakang</label>
			<div class="col-sm-9">
				<input type="text" name="last_name" class="form-control" placeholder="Nama Belakang" value="<?php echo e(old('last_name', $user->last_name)); ?>">
			</div>
		</div>
		<div class="form-group required">
			<label for="mobile_number" class="col-sm-3 control-label">No.Handphone</label>
			<div class="col-sm-9">
				<input type="text" onkeypress="return isNumberKey(event)" name="mobile_number" class="form-control" placeholder="No. Handphone" value="<?php echo e(old('mobile_number', $user->mobile_number)); ?>">
			</div>
		</div>
		<div class="form-group required">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-sm-9">
				<select class="form-control" name="branch_id">
					...
					<option value="<?php echo e($branch->id); ?>" <?php if($user->branch_id == $branch->id): ?><?php echo e('selected'); ?><?php endif; ?>><?php echo e($branch->name); ?></option>
		...
		<div class="form-group required">
			...
			<div class="col-sm-9">
				<input type="text" name="work_position" class="form-control" placeholder="Jabatan Pekerjaan" value="<?php echo e(old('work_position', $user->work_position)); ?>">
			</div>
		</div>
		<div class="form-group required">
