        ...
        <table border="0" width="800" cellpadding="0" cellspacing="0" class="container" style="width:800px;max-width:800px;">
          ...
          <tr>
            <td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff">
              ...
              <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;color:#374550">SPBM
              </div>
              <br>
              ...
              <div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
                <table width="100%">
                  ...
                  <tr>
                    ...
                    <th><?php if($advanceNotice->type == 'inbound'): ?> Shipper <?php else: ?> Cabang/Subcabang <?php endif; ?></th>
                    <td>:</td>
                  ...
                  <tr>
                    ...
                    <th><?php if($advanceNotice->type == 'inbound'): ?> Shipper <?php else: ?> Cabang/Subcabang <?php endif; ?> Address</th>
                    <td>:</td>
                  ...
                  <tr>
                    ...
                    <th><?php if($advanceNotice->type == 'inbound'): ?> Cabang/Subcabang <?php else: ?> Consignee <?php endif; ?></th>
                    <td>:</td>
                  ...
                  <tr>
                    ...
                    <th><?php if($advanceNotice->type == 'inbound'): ?> Cabang/Subcabang <?php else: ?> Consignee <?php endif; ?> Address</th>
                    <td>:</td>
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <?php if(isset($advanceNotice->warehouse)): ?>
                    <th>Warehouse</th>
                    <td>:</td>
