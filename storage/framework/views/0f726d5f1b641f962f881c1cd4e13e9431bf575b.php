...
<head>
    ...
    <title>Picking Plan Print</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="col-3">
            ...
            <p><?php echo e($collections->stock_transport->origin->name); ?></p>
            <p><?php echo e($collections->ref_code); ?></p>
            <p><?php echo e($collections->employee_name); ?></p>
        </div>
        ...
        <div class="col-3">
            ...
            <p><?php echo e($collections->stock_transport->destination->name); ?></p>
            <p><?php echo e($collections->forklift_start_time); ?></p>
            <p><?php echo e($collections->forklift_end_time); ?></p>     
            ...
            <table width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e(!empty($value->qty) ? $value->qty : ''); ?></td>
                        <td><?php echo e($value->uom->name); ?></td>
                        <td><?php echo e($value->storage->code); ?></td>
                    </tr>
    ...
    <div class="wrapper" style="margin-top: 50px;">
        ...
        <div class="col-2">
            <p>Handling</p>
            <p>Total Labor: <?php echo e($collections->total_labor); ?></p>
            <p>Total Pallet: <?php echo e($collections->total_pallet); ?></p>
            <p>Forklift</p>
        </div>
        <div class="col-1">
            <p>Type</p>
