...
<form action="<?php echo e($action); ?>" method="POST" class="form-horizontal">
	...
	<div class="box-body">
		<div class="form-group required">
			...
			<div class="col-sm-9">
				<select class="form-control select2" name="commodity_id">
					...
					<option value="<?php echo e($commodity->id); ?>" <?php if($packing->commodity_id == $commodity->id): ?><?php echo e('selected'); ?><?php endif; ?>><?php echo e($commodity->code); ?> - <?php echo e($commodity->name); ?></option>
		...
		<div class="form-group required">
			...
			<div class="col-sm-9">
				<input type="text" name="name" class="form-control" placeholder="Nama" value="<?php echo e(old('name', $packing->name)); ?>">
			</div>
		</div>
	</div>
	<!-- /.box-body -->
