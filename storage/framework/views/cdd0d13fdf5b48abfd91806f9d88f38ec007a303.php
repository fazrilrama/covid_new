...
<div class="row">
	<div class="col-md-12">
		<div class="box box-default">
			<form method="POST" action="<?php echo e(route('update_status')); ?>" class="form-horizontal"  enctype="multipart/form-data">
			<?php echo csrf_field(); ?>
			{{ #dataDivre}}
...
<input type="hidden" value="<?php echo e(route('api.gicomplete')); ?>" id="list_expedition">
