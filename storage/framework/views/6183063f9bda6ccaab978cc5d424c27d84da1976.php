...
<div class="row">
	<div class="col-md-6">
		<div class="box box-default">
            ...
            <!-- form start -->
			<form action="<?php echo e(route('profile')); ?>" method="POST" class="form-horizontal">
			    <?php echo csrf_field(); ?>
				<div class="box-body">
					...
					<div class="form-group required">
						...
						<div class="col-sm-9">
							<input type="text" name="mobile_number" class="form-control" placeholder="Mobile Number" value="<?php echo e(old('mobile_number', $user->mobile_number)); ?>">
						</div>
					</div>
					<?php if($user->branch): ?>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<p class="form-control-static"><?php echo e($user->branch->name); ?></p>
						</div>
					</div>
					<?php endif; ?>
					<div class="form-group required">
						...
						<div class="col-sm-9">
							<input type="text" name="work_position" class="form-control" placeholder="Posisi" value="<?php echo e(old('work_position', $user->work_position)); ?>">
						</div>
					</div>
					<div class="form-group required">
